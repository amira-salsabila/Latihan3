...
public class ListPahlawanData {
    ...
    public static ArrayList<ListPahlawanModel> getHeroList() {
        ListPahlawanModel modelListPahlawan = null;
        ArrayList<ListPahlawanModel> list = new ArrayList<>();

        for (int i = 0; i < heroNames.length; i++) {
            modelListPahlawan = new ListPahlawanModel();
            modelListPahlawan.setHeroName(heroNames[i]);
            modelListPahlawan.setHeroDetail(heroDetails[i]);
            modelListPahlawan.setHeroImage(heroesImages[i]);

            list.add(modelListPahlawan);
        }
        return list;
    }
}
